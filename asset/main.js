...
"use strict";
/* harmony export (immutable) */ exports["b"] = today;
/* harmony export (immutable) */ exports["c"] = normalizeDay;
/* harmony export (immutable) */ exports["a"] = play;
/**
 * @file Util
...
if (__vue_options__.functional) {console.error("[vue-loader] exam.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__item_vue__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exam_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__exam_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__exam_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__header_vue__ = __webpack_require__(12);
...
function query(date) {
    if (!date) {
        date = {
            start: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* today */])(),
            end: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* today */])()
        };
    }
...
/* harmony default export */ exports["default"] = {
    components: {WHeader: __WEBPACK_IMPORTED_MODULE_3__header_vue___default.a, WItem: __WEBPACK_IMPORTED_MODULE_1__item_vue___default.a, WExam: __WEBPACK_IMPORTED_MODULE_2__exam_vue___default.a},
...
/* harmony default export */ exports["default"] = {
    components: {WItem: __WEBPACK_IMPORTED_MODULE_1__item_vue___default.a},
    props: {
        list: {
            type: Array,
            default() {
    ...
    methods: {
        play() {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* play */])(this.item.pronunciation.uk);
            if (this.checked) {
...
/* harmony default export */ exports["default"] = {
    ...
    methods: {
        ...
        submit(type) {
            ...
            if (type === TYPE_CUSTOM) {
                date = {
                    start: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* normalizeDay */])(this.startDate),
                    end: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* normalizeDay */])(this.endDate)
                };
            }
            else {
...
/* harmony default export */ exports["default"] = {
    ...
    methods: {
        play(e) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* play */])(src);
        }
    }
};
...
module.exports={render:function (){with(this) {
  return _h('div', {
    ...
    attrs: {
      ...
      "testable": !!list.length
    },
    on: {
      "submit": search,
      "test": startExam
    }
  }), " ", (list.length) ? _h('main', [_h('w-exam', {
    ref: "examArea",
    attrs: {
      "style": "display:none",
      "list": list
...
module.exports={render:function (){with(this) {
  ...
  }, [_m(0), " ", _m(1), " ", _m(2), " ", _m(3), " ", (custom) ? _h('li', {
    attrs: {
      "data-type": "custom",
...
module.exports={render:function (){with(this) {
  return _h('div', {
    ...
    attrs: {
      "data-src": data.pronunciation.uk
    }
  }, [(displayWord) ? _h('strong', [_s(data.word)]) : _e(), " ", _h('span', {
    staticClass: "pos"
  }, [_s(data.type)]), _h('span', {
    staticClass: "phon",
    on: {
      "click": play
    }
  }, [_s(data.phonogram)]), " ", (displayWord) ? _h('button', {
    on: {
      "click": play
    }
  }, ["Pronounce"]) : _e()]), " ", _h('ul', {
    staticClass: "mean-list"
  }, [_l((data.means), function(mean) {
    return _h('li', [(mean.title) ? _h('b', [_s(mean.title)]) : _e(), _s(mean.text)])
  })])])
}},staticRenderFns: []}
if (false) {
  module.hot.accept()
...
module.exports={render:function (){with(this) {
  return _h('div', {
    ...
    staticClass: "sorce"
  }, [_h('p', [_h('strong', [_s(sorce)]), " / " + _s(count)]), " ", _h('p', [_h('button', {
    ref: "finishButton",
    on: {
      "click": finish
    }
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./header.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./item.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./item.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./exam.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-4!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./exam.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_app_vue__ = __webpack_require__(4);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#app',
    render: create => create(__WEBPACK_IMPORTED_MODULE_1__component_app_vue___default.a)
});
